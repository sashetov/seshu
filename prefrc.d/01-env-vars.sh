...
export PICS_DIR='/data/pics/';                                                #DIRS TO USE FOR RAND IMAGES
...
export LDAPADMINTOOL="/opt/LdapAdminTool/"                                    #PATH TO LDAPADMIN TOOL
...
export JAVA_HOME=/usr/lib/jvm/java-17-openjdk/                                #JAVA_HOME
export PKG_CONFIG_PATH="/usr/lib64/pkgconfig/";                               #PKG_CONFIG_PATH
export PKG_CONFIG_PATH="$PKG_CONFIG_PATH:/usr/lib/pkgconfig/";
export PKG_CONFIG_PATH="$PKG_CONFIG_PATH:/usr/local/lib/pkgconfig/";
export PKG_CONFIG_PATH="$PKG_CONFIG_PATH:/usr/share/pkgconfig/";
export LOCAL_BIN="$HOME/.local/bin";                                          #LOCAL BINARIES, INSTALLED BY SUCH THINGS AS pip install --user
export PATH_ORIG="$PATH";                                                     #ORIGINAL PATH SETTINGS SAVED IN PATH_ORIG
export OPAM_SWITCH_PREFIX='/home/sasheto/.opam/default';
export CAML_LD_LIBRARY_PATH='/home/sasheto/.opam/default/lib/stublibs:/usr/lib64/ocaml/stublibs:/usr/lib64/ocaml';
export OCAML_TOPLEVEL_PATH='/home/sasheto/.opam/default/lib/toplevel';
export MANPATH="$MAPNPATH:/home/sasheto/.opam/default/man";
...
export PATH+=":$LDAPADMINTOOL";
export PATH+=":$BCC_TOOLS";
export PATH+=":$PATH_ORIG";
export PATH+=":$JAVA_HOME/bin";
export PATH+=":$LOCAL_BIN";
export PATH+=":${OPAM_SWITCH_PREFIX}/bin"
